...
namespace InventoryControlLib.Model
{
    public class CatalogItemModel : ItemModel
    {
        ...
        public CatalogItemModel(string id, string name, IList<ItemType> type, string cost, string weight, string rarity, string attunement, string properties, string description, string source, double cellWidth, double cellHeight, int spanX = 1, int spanY = 1, bool isStackable = false, string imageUri = "")
        ...
        public CatalogItemModel(string id, string name, ItemType type, string cost, string weight, string rarity, string attunement, string properties, string description, string source, double cellWidth, double cellHeight, int spanX = 1, int spanY = 1, bool isStackable = false, string imageUri = "")
